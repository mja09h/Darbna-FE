    ...
    <View style={[styles.container, { backgroundColor: HEADER_BG_COLOR }]}>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.content, { color: colors.text }]}>
            By accessing and using Darbna, you accept and agree to be bound by
          ...
          <Text style={[styles.content, { color: colors.text }]}>
            The materials on Darbna are provided on an 'as is' basis. Darbna
          ...
          <Text style={[styles.content, { color: colors.text }]}>
            ...
            to use Darbna, even if Darbna or a Darbna authorized representative
